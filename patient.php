        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="gestione.php">Doctor Management<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active">
        ...
        <div class="jumbotron jumbo">
            ...
            <div class="text-center">
              ...
              <table style="margin-left: 10%; margin-right: 20%;"> 		
                ...
                <?php 
                  $i=0;
                  $sql="SELECT paziente.cognome as pcognome, paziente.nome, paziente.codFiscale, paziente.dataNascita, paziente.genere, medico.cognome as mcognome
                        FROM paziente, medico, segue
                        WHERE paziente.codFiscale=segue.codPaziente
                        AND segue.codMedico=medico.codFiscale";
                  $query=mysqli_query($conn, $sql);
                  while($row = mysqli_fetch_array($query)) {						
                ?> 
            <tr>
              <td>
                <?php echo $row['pcognome']; ?> 
              </td> 
              ...
              <td> 
                <?php echo $row['mcognome']; ?> 
              </td>
              <td>
                <?php echo '<a href="medical_records.php?view=' .$row['codFiscale'] . ' " class="trash">'?><i class="fa fa-eye" aria-hidden="true"></i></a>
              </td>  
              <td>
                <button class="btn btn-outline-success my-2 my-sm-0 buttons" type="submit">Change Doctor</button>
              </td>            
              </tr> 
              </center>
              <?php $i++; } ?> 
